...
const Prototype1 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      {/* Main Content - Centered iPhone Only */}
      <div className="w-full h-screen flex items-center justify-center px-4 py-4">
        <div className="flex justify-center items-center h-full w-full">
          
          {/* iPhone Mockup - Proportionally Scaled */}
          <div className="flex items-center justify-center h-full w-full">
            <div style={{
              transform: `scale(${Math.min(3, Math.min(windowSize.width * 0.85 / 384, windowSize.height * 0.85 / 850))})`,
              transformOrigin: 'center center'
            }}>
              {/* iPhone 16 Pro Frame - Fixed proportions */}
              <div className="bg-black rounded-[3rem] p-3 shadow-2xl mx-auto w-96">
                {/* iPhone Screen - Fixed aspect ratio */}
              ...
              <div className="text-center mt-4">
                <p className="text-gray-400 text-sm">iPhone 16 Pro - Demo</p>
